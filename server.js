...
function insertSampleData() {
  ...
  const culturalClubs = [
    "男声合唱団", "交響楽団", "E.S.S", "将棋部", "写真部", "混声合唱団", "フロイントコール", 
    "軽音楽部 ROCK", "軽音楽部 SWING", "ギタークラブ", "天文同好会", "落語研究部", "アイセック", 
    "古美術研究会", "アマチュア無線クラブ", "奇術研究会", "鉄道研究会", "マンドリンクラブ", 
    "書道部", "コントラクトブリッジクラブ", "茶道部", "フォークソング同好会", "陶芸部", 
    "生物研究会", "喜多流能楽研究会", "創作人形劇団 せせくらせ", "舞踏研究会", "吹奏楽団", 
    "美術部", "囲碁部", "映画研究部", "考古学研究会", "人権哲学研究会", "Bible Club", 
    "法律相談部", "ボランティアサークル フロンティア", "ＳＦ研究会", "推理小説研究会", 
    "第２劇場", "コンピュータクラブ", "漫画研究会", "アニメーション研究会", "ボードゲーム研究会",
    "銀簫会", "国際法学研究会", "電子技術研究会（ツールボックス）", "クイズ研究会（ＯＵＱＳ）", 
    "劇団ちゃうかちゃわん", "阪大ピアノの会", "ＲＰＧ研究会", "劇団六風館", "文芸部", 
    "アカペラサークル inspiritual voices", "競技かるた会", "現代芸術を考える会", 
    "公共政策研究会", "お祭りダンスサークル祭楽人", "環境サークルＧＥＣＳ", 
    "フラメンコ部 Al Compás", "合唱団TEMPEST", "映像制作チーム OUT+V", "国際問題研究会", 
    "エレクトーンサークル HANON", "ベリーダンスサークル Halaawaat", "レゴ部", "Robohan", 
    "阪大競技プログラミング部「RAINBOU」", "大阪大学フォーミュラレーシングクラブ(OFRAC)", 
    "飛行機制作研究albatross", "ミュージカルサークル みーあキャット", "学生団体Flagship"
  ];
